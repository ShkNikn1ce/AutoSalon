...
> Проект активно разрабатывается. README может отставать от актуального кода — 
> актуальный список зависимостей см. в pom.xml (часть добавлена заранее, под будущий функционал).
...
- Kafka(асинхронная обработка заявок на покупку)
- Redis(кэширование списка автомобилей / брендов)
- Docker
